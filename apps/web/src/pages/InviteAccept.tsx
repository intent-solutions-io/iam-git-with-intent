 ...
 * Invite Accept Page
 *
 * Phase 12: Accept a workspace invitation.
 */
...
export function InviteAccept() {
  ...
  useEffect(() => {
    if (user && token && !accepting && !success) {
      handleAccept();
    }
  }, [user, token]);
  ...
  const handleAccept = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        navigate(`/dashboard?tenant=${result.membership.tenantId}`);
      }, 2000);
    } catch (err) {
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      // After sign in, the useEffect will trigger accept
    } catch (err) {
      ...
      <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 w-full max-w-md">
        {success ? (
          ...
          <>
            ...
            <p className="text-gray-600 text-center mb-6">
              You've been invited to join a Git With Intent workspace.
            </p>
          ...
          <>
            ...
            <p className="text-gray-600 text-center mb-6">
              Sign in with GitHub to accept this invitation.
            </p>
